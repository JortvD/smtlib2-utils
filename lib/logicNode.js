...
class SMTLogicNode extends SMTNode {
    ...
    /**
     * Creates a comment token with the specified value and adds that as a child to this logic 
     * node.
     * @param {String} value The value for the comment token.
     */
    comment(value) {
    ...
    createNode(name, children) {
        const node = new SMTLogicNode(name, children.filter(child => child !== undefined));
        this.addChild(node);
